...
abstract class $AuthStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AuthStatus status, User? user, bool isLogin});
}
...
class _$AuthStateImpl implements _AuthState {
  const _$AuthStateImpl({this.status = AuthStatus.initial, this.user, this.isLogin = false});
  ...
  @override
  String toString() {
    return 'AuthState(status: $status, user: $user, isLogin: $isLogin)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, user, isLogin);
...
abstract class _AuthState implements AuthState {
  const factory _AuthState({final AuthStatus status, final User? user, final bool isLogin}) =
      _$AuthStateImpl;
